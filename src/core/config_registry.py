...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TREND_SYSTEM_ENABLED": {
        "title": "Trend System Enabled",
        "description": "Enable the A-share trend trading system module.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TREND_SYSTEM_DEGRADED_MIN_FLOAT_MARKET_CAP_B": {
        "title": "Trend System Min Float Market Cap (B)",
        "description": "Minimum float market cap in billions when the trend system enters degraded mode.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TREND_SYSTEM_DEGRADED_MIN_AVG_AMOUNT_B": {
        "title": "Trend System Min Avg Amount (B)",
        "description": "Minimum average daily turnover in billions when the trend system enters degraded mode.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
